...
const DashboardSidebar = () =>{
	...
	return(
		...
		<>
			...
			<div className='text-white sidebarWrap rounded p-2'>
					...
					<div>
						...
						<div className='bg-chart rounded w-100 box-sh-lg px-2 py-3 flex-v-new1'>
							<div className='flex-h-new w-100'> 
								<div className='flex-h-new w-100'>
									<div className='flex-h-new91 w-100'>
										<div className='flex-v-new'>
											<div className='bora100 p-1 andriodchrome-bg flex-h-new'>
												<img src={andriodchrome} />
											</div>

											<div className='ml05 fos13 text-dark'>
												Stackers Profits <span className='fos10'>(23 days)</span>
											</div>
										</div>
										<div className='fos12 flex-h-new text-dark'>
											<div>Last 24 Hrs</div>
								...
								<div className='flex-h-new91 w-100 mt-2 text-dark'>
						...
						<div className='flex-h-new w-100'> 
							<div className='flex-h-new w-100'>
								<div className='flex-h-new91 w-100'>
									...
									<div className='fos10 flex-h-new text-dark'>
										<div>Last 24 Hrs</div>

...
const GameEconomy = () =>{
	...
	return(
		...
		<>
		<div className='mt-1 fos13 flex-1 p-2 bg-all box-sh rounded text-dark'>
			...
			<div className='mt-4 text-white flex-h-new1 w-100 fos12'>
				...
				<div className='flex-h-new1 mt-3 text-dark'>Payment Method:</div>

				<div className='flex-v-new mt-3 w-100 text-dark'>
					<div className='flex-1 bg-green rounded text-white flex-h-new mr-2 w-100 p-2'>
						<img src={mastercard} width='24px' />
						<div className='ml-2'>Credit/Debit Card</div>
					</div>

					<div className='flex-1 bg-green rounded text-white flex-v-new mx-2 w-100 p-3'>
						<img src={paypal} width='30px' />
						<div className='ml-3'>PayPal</div>
					</div>

					<div className='flex-1 bg-green rounded text-white stripe flex-v-new mx-2 w-100 p-35'>
				...
				<div className='w-100 flex-v-new mt-4 pr-3'>
					<div className='flex-1 flex-v-new'>
						...
						<div className='flex-1'>
							<div className='ml-2 text-dark'>Card:</div>
				...
				<div className='w-100 flex-v-new mt-4 pr-3'>
					<div className='flex-1 flex-v-new'>
						...
						<div className='flex-1'>
							<div className='ml-2 text-dark'>CVC/CVV:</div>
				...
				<div className='w-100 flex-h-new mt-4'>
					<div className='flex-1 flex-h-new1 w-100 text-dark'>
				...
				<div className='w-100 flex-v-new mt-4 pr-3'>
					<div className='flex-1 flex-v-new'>
						...
						<div className='flex-1'>
							<div className='ml-2 text-dark'>Zip Code / Postal Code:</div>
							<input className='rounded mt-1 ml-2 input3 w-100 px-2' type='text' placeholder='Zip code -- postal code'/>
						</div>
					</div>
				</div>

				<div className='flex-h-new5 w-100  text-dark'>
